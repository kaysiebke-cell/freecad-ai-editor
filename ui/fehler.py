...
_MUSTER = [
    ...
    (r"name '(Part|Mesh|Draft|Arch|Sketcher|FreeCAD|FreeCADGui|App|Gui)' is not defined",
     "❌ FreeCAD-Modul nicht importiert\n\n"
     "»{0}« wurde verwendet, aber nicht importiert.\n\n"
     "Lösung – diese Zeile(n) oben im Makro ergänzen:\n"
     "  import FreeCAD as App\n"
     "  import FreeCADGui as Gui\n"
     "  import Part          ← nur wenn Part.make…() verwendet wird\n"
     "  import Mesh          ← nur für Mesh-Operationen\n\n"
     "Tipp: Verwende besser doc.addObject('Part::Box') statt Part.makeBox()\n"
     "      → dann wird kein 'import Part' benötigt."),

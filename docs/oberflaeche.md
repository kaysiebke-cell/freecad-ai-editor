...
**Toolbar-Buttons** schalten die 11 Panels ein und aus. Die Buttons zeigen standardmäßig nur das Emoji (32 px). Im `♿ Hilfe+Zugang`-Dock → `♿ Zugang`-Tab kann die Beschriftung mit „Icons mit Text" eingeblendet werden, z. B. `⚙ Einst.`.
